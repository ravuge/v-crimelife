...
namespace GVMP
{
    class HouseModule : GVMP.Module.Module<HouseModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            NAPI.Marker.CreateMarker(1, new Vector3(1138, -3198, -40).Subtract(new Vector3(0, 0, 1)), new Vector3(), new Vector3(), 1.0f, new Color(245, 0, 184), false, uint.MaxValue);
            ...
            NAPI.Marker.CreateMarker(1, new Vector3(1130, -3194, -40).Subtract(new Vector3(0, 0, 1.4)), new Vector3(), new Vector3(), 1.0f, new Color(245, 0, 184), false, uint.MaxValue);
