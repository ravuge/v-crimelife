    ...
    class HouseClassModule : GVMP.Module.Module<HouseClassModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            foreach(HouseClass houseClass in houseClasses)
            {
                ...
                NAPI.Marker.CreateMarker(1, houseClass.HouseLocation.Subtract(new Vector3(0, 0, 1)), new Vector3(), new Vector3(), 1.0f, new Color(245, 0, 184), false, uint.MaxValue);
                ...
                NAPI.Marker.CreateMarker(1, houseClass.KleiderschrankLocation.Subtract(new Vector3(0, 0, 1)), new Vector3(), new Vector3(), 1.0f, new Color(245, 0, 184), false, uint.MaxValue);
            }
