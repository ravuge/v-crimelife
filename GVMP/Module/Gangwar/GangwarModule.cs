    ...
    class GangwarModule : GVMP.Module.Module<GangwarModule>
    {
        ...
        public void Gangwar(Client c, string selection)
        {
            try
            {
                ...
                Marker m = NAPI.Marker.CreateMarker(1, gw.Zone, new Vector3(), new Vector3(), 600, new Color(176, 2, 133), false, Convert.ToUInt32(FactionModule.GangwarDimension));
                ...
                NAPI.Marker.CreateMarker(42, gw.Flag1.Position.Add(new Vector3(0, 0, 1)), new Vector3(), new Vector3(), 1.0f, new Color(245, 0, 184), false, Convert.ToUInt32(FactionModule.GangwarDimension));
                ...
                NAPI.Marker.CreateMarker(42, gw.Flag2.Position.Add(new Vector3(0, 0, 1)), new Vector3(), new Vector3(), 1.0f, new Color(245, 0, 184), false, Convert.ToUInt32(FactionModule.GangwarDimension));
                ...
                NAPI.Marker.CreateMarker(42, gw.Flag3.Position.Add(new Vector3(0, 0, 1)), new Vector3(), new Vector3(), 1.0f, new Color(245, 0, 184), false, Convert.ToUInt32(FactionModule.GangwarDimension));
                ...
                NAPI.Marker.CreateMarker(42, gw.Flag4.Position.Add(new Vector3(0, 0, 1)), new Vector3(), new Vector3(), 1.0f, new Color(245, 0, 184), false, Convert.ToUInt32(FactionModule.GangwarDimension));
            }
            catch(Exception ex)
            {
