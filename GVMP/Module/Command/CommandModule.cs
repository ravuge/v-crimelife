                        ...
                        client.TriggerEvent("openWindow", new object[2]
{
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                ...
                try
                {
                    ...
                    vehicle.NumberPlate = ("VC " + dbPlayer.Adminrank.Permission);
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                ...
                PlayerHandler.GetAdminPlayers().ForEach((DbPlayer dbPlayer2) =>
                {
                    ...
                    {
                        dbPlayer2.SendNotification("Tickets machen sonst fick ich euch. LG Jason!", 6000, "red", "ADMINDIENSTPFLICHT");
                    ...
                    client.TriggerEvent("openWindow", new object[2]
{
            ...
            commandList.Add(new Command((dbPlayer, args) =>
            {
                ...
                dbPlayer.SendNotification("Du hast den Spieler " + name + " offlinegebannt!", 3000, "red");
