    ...
    class FarmingModule : GVMP.Module.Module<FarmingModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            farming.Add(new FarmingModel
            {
                ...
                Item_1 = "Dia",
                Item_2 = "Diamant",
                Sammler = new Vector3(1616541654415441651, 16516516516161, 1161651651),
                PickupCount = 1,
                Verarbeiter = new Vector3(1616541654415441651, 16516516516161, 1161651651),
                RemoveCount = 1,
                AddCount = 0,
                ColShapeRange = 0
            }); farming.Add(new FarmingModel
            ...
            farmingPrices.Add("Diamant", (int)random.Next(9057, 12349));
            farmingPrices.Add("Goldbarren", (int)random.Next(9057, 12349));
            ...
            try
            {
                ...
                if (value == "Goldbarren")
                {
                    if (dbPlayer.GetItemAmount("Goldbarren") >= 1)
                    {
                        ...
                        dbPlayer.addMoney(farmingPrices["Goldbarren"]);
                ...
                if (value == "Diamant")
                {
                    if (dbPlayer.GetItemAmount("Diamant") >= 1)
                    {
                        dbPlayer.UpdateInventoryItems("Diamant", 1, true);
                        dbPlayer.addMoney(farmingPrices["Diamant"]);
                        dbPlayer.SendNotification("Du hast 1x Diamant verkauft.", 3000, "green", "DEALER");
                    }
                    else
                    {
                        dbPlayer.SendNotification("Du besitzt nicht genug Ephidrinkonzentrat!", 3000, "red");
